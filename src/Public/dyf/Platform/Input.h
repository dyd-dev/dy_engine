...
namespace dyf::Platform
{
    ...
    // Raw, ordered events. Coordinates are window-content coordinates, not framebuffer pixels.
    struct InputEvent
    {
	...
	public:
	    ...
	    // Valid until the next PollEvents on any Window. UI capture never erases raw input.
