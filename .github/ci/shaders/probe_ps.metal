...
fragment float4 main0(Input input [[stage_in]], constant Constants& constants [[buffer(15)]],
                      texture2d<float> colorTexture [[texture(0)]], sampler colorSampler [[sampler(1)]])
{
